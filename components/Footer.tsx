...
export const Footer: React.FC<Props> = () => {
  return (
    <div className='bg-gray-100 border-t border-gray-300'>
      <div className='max-w-5xl mx-auto lg:px-0 px-4 py-16 border-b border-gray-300'>
        <div className='flex items-start justify-start flex-wrap'>
          <div className='w-full lg:w-1/4 mb-6'>
            <h3 className='text-gray-900 text-sm font-semibold pb-3'>Airbnb</h3>
            <ul className='leading-loose'>
              <li className='text-gray-600 text-sm tracking-wide pb-1'>
                <a href='#'>Careers</a>
              </li>
              <li className='text-gray-600 text-sm tracking-wide pb-1'>
                <a href='#'>News</a>
          ...
          <div className='w-full lg:w-1/4 mb-6'>
            <h3 className='text-gray-900 text-sm font-semibold pb-3'>
              Discover
            </h3>
            <ul className='leading-loose'>
              <li className='text-gray-600 text-sm tracking-wide pb-1'>
          ...
          <div className='w-full lg:w-1/4'>
            <div className='flex items-center justify-start flex-wrap mt-2 pb-3'>
      ...
      <div className='max-w-5xl mx-auto flex items-center justify-start flex-wrap py-6 px-4 lg:px-0'>
        <svg
        ...
        <p className='pl-4 text-sm text-gray-600 font-thin'>
