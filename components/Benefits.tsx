...
export const Benefits: React.FC<Props> = () => {
  return (
    <div className='max-w-5xl mx-auto my-1 py-12 px-4 lg:px-0 border-b border-gray-300'>
      <h3 className='font-semibold text-2xl text-gray-800 border-b border-gray-300 pb-3'>
