export default () => {
	return (
		<div className='bg-gray-100 border-t border-gray-300'>
			<div className='max-w-5xl mx-auto lg:px-0 px-4 py-16 border-b border-gray-300'>
				<div className='flex items-start justify-start flex-wrap'>
					...
					<div className='w-full lg:w-1/4'>
						<div class='flex items-center justify-start flex-wrap mt-2 pb-3'>
							<a href='#' class='mr-2'>
								<svg
									viewBox='0 0 32 32'
									role='img'
			...
			<div class='max-w-5xl mx-auto flex items-center justify-start flex-wrap py-6 px-4 lg:px-0'>
				<svg
				...
				<p class='pl-4 text-sm text-gray-600 font-thin'>&copy; 2019 Airbnb, Inc. All rights reserved.</p>
			</div>
		</div>
	);
};
